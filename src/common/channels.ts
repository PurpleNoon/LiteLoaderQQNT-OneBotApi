...
export const CHANNEL_SEND_NEW_MESSAGE_TO_MAIN = "llonebot_send_new_message_to_main"
export const CHANNEL_INSERT_MESSAGE_HISTORY = "llonebot_insert_message_history"
export const CHANNEL_HANDLE_SINGLE_MESSAGE = "llonebot_handle_single_message"
export const CHANNEL_BACK_SINGLE_MESSAGE = "llonebot_back_single_message"
